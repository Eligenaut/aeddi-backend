...
<head>
    ...
    <style>
        ...
        .code-box { background: #f5f3ff; border: 2px dashed #7c3aed; border-radius: 12px; padding: 20px; text-align: center; margin: 20px 0; }
        .code-box .code { font-size: 36px; font-weight: bold; letter-spacing: 8px; color: #7c3aed; font-family: 'Courier New', monospace; }
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="color: #666; font-size: 13px; margin-top: 20px; text-align: center;">
                Retournez sur l'application et saisissez ce code pour réinitialiser votre mot de passe.
            </p>
