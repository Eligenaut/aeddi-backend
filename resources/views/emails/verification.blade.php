...
<head>
    ...
    <title>Vérification de votre compte AEDDI</title>
    <style>
        body {
        ...
        @media (max-width: 480px) {
            ...
            .verification-code { font-size: 1.4rem; padding: 16px; }
        }
    </style>
</head>
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Bonjour,</p>
            @endisset
            <p>Bienvenue dans l'Association des Étudiants de Diego Suarez !</p>
            ...
            <p>Après vérification, vous pourrez accéder à votre tableau de bord et participer aux activités de l'association.</p>
            <a href="mailto:aeddi@email.com" class="cta-btn">Besoin d'aide ? Contactez-nous</a>
